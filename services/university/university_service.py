...
class UniversityService(BaseService):
    ...
    def create_multiple_students(self, student_requests: list[StudentPostRequest]) -> list[StudentPostResponse]:
    ...
    def get_grades_statistics(
        ...
        response = self.grade_helper.get_stats(group_id=group_id, student_id=student_id, teacher_id=teacher_id)
